    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-10">
        ...
        <p className="max-w-2xl text-lg leading-relaxed text-slate-500">
          Weekly intelligence for deathcare professionals. Legislative updates, industry trends,
          and community highlights — every Monday morning.
        </p>
        <div className="mt-4">
          <Link
            href="/join"
      ...
      <section className="mb-10">
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          <div className="bg-gradient-to-r from-teal-800 to-teal-900 px-6 py-8 text-white">
            ...
            <h2 className="font-serif text-xl font-bold leading-snug">{latest.headline}</h2>
            <p className="mt-3 text-sm leading-relaxed text-teal-200">{latest.subheadline}</p>
          </div>

          <div className="p-6">
            {/* Editor's note */}
            <div className="mb-6 rounded-xl border border-gold-100 bg-gold-50/60 px-4 py-3.5">
          ...
          <div className="space-y-4">
            {archive.map((issue) => (
              ...
              >
                ...
                <h3 className="mb-1 font-serif text-base font-bold text-slate-800 leading-snug">
                  {issue.headline}
                </h3>
      ...
      <div className="mt-12 rounded-2xl bg-gradient-to-r from-teal-700 to-teal-900 p-7 text-center text-white">
        ...
        <p className="mb-5 text-sm text-teal-200">
          The State of Deathcare lands every Monday. It takes 5 minutes to read and saves you
          hours of tracking bills, discussions, and industry moves yourself.
        </p>
        <Link
          href="/join"
