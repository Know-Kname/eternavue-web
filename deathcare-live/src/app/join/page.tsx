...
export default function JoinPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      {/* Verification note */}
      <div className="mb-8 rounded-xl border border-gold-100 bg-gold-50/60 p-4">
        <div className="flex gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-800">Verification protects the community</p>
      ...
      <div className="rounded-2xl border border-teal-100 bg-teal-50/60 p-6 text-center">
        <h2 className="mb-2 font-serif text-xl font-bold text-slate-900">
          Ready to join?
        </h2>
        <p className="mb-5 text-sm text-slate-600">
          Create your free account, then complete your professional profile.
          Founding members get lifetime verified status at no cost.
        </p>
