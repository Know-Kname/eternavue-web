    ...
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <p className="max-w-2xl text-lg leading-relaxed text-slate-500">
          Post anonymous requests for proposals to reach verified deathcare suppliers.
          Suppliers respond privately — operators share contact details only if interested.
        </p>
      </div>
      ...
      <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        {[
          ...
          <div key={s.step} className="rounded-xl border border-slate-200 bg-white p-5">
            <div className={`mb-3 inline-flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold ${s.color}`}>
              {s.step}
            </div>
