    ...
    return (
      <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="mb-2 font-serif text-2xl font-bold text-slate-900">Authentication coming soon</h1>
    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <Link href="/join" className="font-medium text-teal-600 transition-colors hover:text-teal-700">
            Apply for access
          </Link>
        </p>
      </div>
