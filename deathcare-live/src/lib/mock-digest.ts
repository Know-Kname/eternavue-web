...
export const MOCK_DIGEST_ISSUES: DigestIssue[] = [
  {
    ...
    headline: 'Michigan Preneed Bill Gains Floor Momentum; Ohio Alkaline Hydrolysis Clears Committee',
    subheadline:
  ...
  },
  {
    ...
    headline: "Illinois Green Burial Bill Stalls; Michigan's Preneed Reform Enters Committee Markup",
    subheadline:
