    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl leading-relaxed text-slate-500">
          deathcare.live is the professional community and legislative intelligence platform for the
          death care industry — a space where verified operators can track state legislation, share
          field knowledge, build coalitions, and collectively shape industry policy.
        </p>
      </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-8">
          ...
          <div className="space-y-4 text-base leading-relaxed text-slate-600">
            <p>
              ...
              The kind of institution that doesn't just survive — it endures by staying connected to
            ...
            <p>
              ...
              Financial professionals have compliance platforms that track every rule change in real
              time.
            </p>
            <p>
              Funeral directors have email chains, trade association newsletters, and phone calls
              with colleagues they happen to know. When a state legislature moves to change preneed
              fund requirements or restrict alkaline hydrolysis, the industry typically hears about
              it late — and responds even later.
            </p>
      ...
      {/* What we're building */}
      <section className="mb-12">
        <h2 className="mb-4 font-serif text-2xl font-bold text-slate-900">The five pillars</h2>
      ...
      <section className="mb-12">
        <div className="rounded-2xl border border-teal-100 bg-teal-50/60 p-7">
          ...
          <p className="mb-4 text-base leading-relaxed text-slate-600">
            The platform launches in Michigan — the home of Detroit Memorial Park, the first cohort
            of verified operators, and the most active state legislative session in our coverage
            area. Density before breadth: 50 deeply engaged Michigan operators is more valuable than
            5,000 passive national followers.
          </p>
          <p className="text-sm text-slate-500">
            Ohio, Illinois, Washington, and Texas are the next wave. Founding members from any state
            are welcome and will receive platform access as coverage expands.
          </p>
      ...
      <div className="text-center">
        ...
        <p className="mx-auto mb-6 max-w-lg text-base text-slate-500">
          Founding members get lifetime verified status at no cost and a voice in shaping what the
          platform becomes. The founding period closes when we reach operational capacity.
        </p>
